...
Installing "WordPress Plugin Boilerplate" can be done either by searching for "WordPress Plugin Boilerplate" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
